...
class getPulseMain(object):

    """
    Identify a face from webcam stream, then (poor man's) extraction of 
    forehead.

    Per paper, use average green-light intensity from the forehead over time
    to detect & estimate a person's pulse.
    """
    ...
    def main_loop(self):
        ...
        self.key_handler()
        self.processor.camera = self.cameras[self.selected_cam]
